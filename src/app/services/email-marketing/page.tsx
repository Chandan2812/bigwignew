    ...
    <div className="bg-[var(--color1)]">
      ...
      <section className=" py-12 ">
        ...
        "
          ...
          transition-all"
                  >
                    <span className="text-[var(--color5)] drop-shadow-[0_0_6px_var(--color5)]">
                      {item.icon}
                    </span>
                  </div>
          ...
          <Slider {...settings}>
            ...
            "
                >
                  ...
                  <h3 className="text-lg font-semibold text-[var(--color5)] drop-shadow-[0_0_6px_var(--color5)] relative z-10">
                    {item.title}
                  </h3>
        ...
        <div className="relative z-10">
          ...
          <div className="w-11/12 md:w-5/6 mx-auto grid md:grid-cols-2 gap-10 items-center">
              ...
              <ul className="space-y-3 text-gray-200">
                {[
                  ...
                  <li key={i} className="flex gap-3">
                    <span className="w-3 h-3 mt-2 rounded-full bg-[var(--color5)] shadow-[0_0_10px_var(--color5)]"></span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="relative">
              ...
              {/* Neon Glow Border */}
              <div className="absolute inset-0 rounded-xl border border-[var(--color5)] opacity-30 pointer-events-none"></div>
            </div>
          </div>
